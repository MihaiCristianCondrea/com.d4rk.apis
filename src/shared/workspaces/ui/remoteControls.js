...
function getBuilderRemoteTemplate() {
  ...
  // Falling back to a minimal template keeps preset hydration stable without changing runtime behavior when the real template is present.
    const templateSource = builderRemoteTemplateSource || `<template data-partial="builder-remote"><div><input data-slot-target="fetch-input" /><button data-slot-target="fetch-button"></button><select data-slot-target="fetch-target"></select><button data-slot-target="github-launch"></button><button data-slot-target="home-debug"><span class="builder-remote-preset-label" data-slot-target="home-debug-label"></span></button><button data-slot-target="home-release"><span class="builder-remote-preset-label" data-slot-target="home-release-label"></span></button><button data-slot-target="lesson-debug"><span class="builder-remote-preset-label" data-slot-target="lesson-debug-label"></span></button><button data-slot-target="lesson-release"><span class="builder-remote-preset-label" data-slot-target="lesson-release-label"></span></button></div></template>`;

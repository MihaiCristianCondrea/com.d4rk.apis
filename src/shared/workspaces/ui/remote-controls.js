...
function getBuilderRemoteTemplate() {
  ...
  // Change Rationale: Test and migration stubs may remap `?raw` HTML imports to empty strings.
  // Falling back to a minimal template keeps preset hydration stable without changing runtime behavior when the real template is present.
    const templateSource = builderRemoteTemplateSource || `<template data-partial="builder-remote"><div><input data-slot-target="fetch-input" /><button class="responsive" data-slot-target="fetch-button"></button><select data-slot-target="fetch-target"></select><button class="responsive" data-slot-target="github-launch"></button><button class="responsive" data-slot-target="home-debug"><span class="builder-remote-preset-label" data-slot-target="home-debug-label"></span></button><button class="responsive" data-slot-target="home-release"><span class="builder-remote-preset-label" data-slot-target="home-release-label"></span></button><button class="responsive" data-slot-target="lesson-debug"><span class="builder-remote-preset-label" data-slot-target="lesson-debug-label"></span></button><button class="responsive" data-slot-target="lesson-release"><span class="builder-remote-preset-label" data-slot-target="lesson-release-label"></span></button></div></template>`;

...
import { NAVIGATION_SECTIONS } from './navigationContent.js';

/**
 * @typedef {import('./navigationContent.js').NavigationItem} NavigationItem
 * @typedef {import('./navigationContent.js').NavigationSection} NavigationSection
 */

...
(function (global) {
    ...
    const routeViewModel = createAppToolkitRouteViewModel();
    const DEFAULT_FILENAME = routeViewModel.defaultFilename;
    const GITHUB_CHANNEL_PATHS = routeViewModel.githubChannelPaths;
    const MIN_GITHUB_TOKEN_LENGTH = routeViewModel.minGithubTokenLength;

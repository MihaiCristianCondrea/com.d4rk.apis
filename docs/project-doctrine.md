...
| `md-dialog`, `md-steppers`, `md-step`, `md-side-sheet`, `md-menu`, `md-menu-item`, `md-outlined-text-field`, `md-outlined-select`, `md-select-option`, `md-filled-card`, `md-icon-button`, `md-filled-button`, `md-filled-tonal-button`, `md-outlined-button`, `md-text-button`, `md-icon` | `app/src/main/res/layout/workspaces/app-toolkit/app-toolkit.html` | Allowed: complex multi-step workflow; replacement is risky without dedicated migration time. |
| `md-icon-button`, `md-outlined-text-field` | `app/src/main/res/layout/workspaces/app-toolkit/screenshot-field.html` | Allowed: input/preview controls lack BeerCSS equivalents; layout is shared. |
| `md-outlined-text-field`, `md-outlined-select`, `md-select-option`, `md-filled-button`, `md-filled-tonal-button`, `md-outlined-button`, `md-text-button`, `md-icon` | `app/src/main/res/layout/workspaces/shared/builder-remote.html` | Allowed: shared remote builder controls rely on MWC until a BeerCSS replacement lands. |

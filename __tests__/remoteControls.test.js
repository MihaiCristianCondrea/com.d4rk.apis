import { initBuilderRemoteControls } from '../app/src/main/js/app/workspaces/shared/remoteControls.js';
...
describe('initBuilderRemoteControls', () => {
    test('hydrates home and lesson presets with workspace-specific dataset', () => {

(function (global) {
    ...
    function initFaqWorkspace() {
        ...
        const modeTargets = {
            ...
            faq: document.querySelector('.faq-product-loader') || entriesContainer
        };
        // Change Rationale: Normalize the workspace mode key to the singular `faq` slug so DOM data attributes,
        // router anchors, and the API folder name stay aligned without plural drift between flows.
        ...
        const modeMessages = {
            ...
            faq: 'Pick a product to load its FAQs directly from the catalog.'
        };

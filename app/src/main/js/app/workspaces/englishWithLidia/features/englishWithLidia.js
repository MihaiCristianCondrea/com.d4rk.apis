...
(function (global) {
    ...
    function initEnglishWorkspace() {
        ...
        // Change Rationale: Hydrate the shared workspace dashboard partial before caching DOM nodes so
        // cross-workspace IDs exist for controller bindings and counters.
